...
import { SanityHeadingWithBlockText, SanityImageType } from '@/lib/sanity/types';
...
const ServiceIntroductionSection:FC<ServiceIntroductionSectionProps> = ({ headingWithBlockText, image }) => {
